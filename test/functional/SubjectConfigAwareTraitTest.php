...
use Dhii\Factory\SubjectConfigAwareTrait as TestSubject;
 ...
 * @since [*next-version*]
 */
class SubjectConfigAwareTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Factory\SubjectConfigAwareTrait';
    ...
    public function testGetSetSubjectConfig()
    {
        $subject = $this->createInstance();
