...
use Dhii\Factory\Exception\FactoryException as TestSubject;
use Exception;
use Xpmock\TestCase;
...
class FactoryExceptionTest extends TestCase
{
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Factory\Exception\FactoryException';
    ...
    public function testCanBeCreated()
    {
        ...
        $this->assertInstanceOf(
            'Dhii\Factory\Exception\FactoryExceptionInterface',
            $subject,
    ...
    public function testConstructor()
    {
        ...
        $subject = new TestSubject($m, $c, $p, $f);
